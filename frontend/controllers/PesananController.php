...
class PesananController extends Controller
{
        ...
        if ($request->isAjax) {
            ...
            */
            ...
            if ($request->isGet) {
                ...
                return [
                    ...
                    'title' => "Create new Pesanan",
                    'content' => '<span class="text-success">Create Pesanan success</span>',
                    'footer' => Html::button('Close', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
            ...
            */
            if ($model->load($request->post())) {
                // $jarak = ;
                $model->jarak = str_replace(",", ".", explode(" ", $request->post()["pesanan-jarak-disp"])[0]);
                $model->harga = str_replace(".", "", explode(" ", $request->post()["pesanan-harga-disp"])[1]);
                // echo "<pre>",
                // var_dump($model);
                // die;
                $model->save();
    ...
    /**
     * Delete an existing Pesanan model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing Pesanan model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
